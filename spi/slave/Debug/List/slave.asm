...
; 0000 002B // Function: Bit7=In Bit6=Out Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 002C DDRB=(0<<DDB7) | (1<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(64)
	OUT  0x17,R30
; 0000 002D // State: Bit7=T Bit6=0 Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0082 // SPI Type: Slave
; 0000 0083 // SPI Clock Rate: 2000.000 kHz
; 0000 0084 // SPI Clock Phase: Cycle Start
; 0000 0085 // SPI Clock Polarity: Low
; 0000 0086 // SPI Data Order: MSB First
; 0000 0087 SPCR=(0<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(64)
	OUT  0xD,R30
; 0000 0088 SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 0089 
